# How to use UseContext in react to share state

In this codebase, you will see how you can use React hook useContext to share state between components. 

### Blogpost

Currently, a detailed blogpost that explain the content of this repo is in the works and will be shared soon.
